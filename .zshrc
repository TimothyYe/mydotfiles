...
export PATH="/usr/local/Cellar/mysql/5.7.13/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Users/Timothy/.rvm/bin:/Users/Timothy/workspace/bin:/usr/local/Cellar/go/1.9.1/bin"
...
export PATH=$PATH:$GOPATH/bin:/usr/local/Cellar/go/1.9.1/bin:~/.mix:/usr/local/share/dotnet
